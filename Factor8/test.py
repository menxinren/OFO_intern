...
def get_dv(start = 20140101,end = 20171231): 
    import jaqs_fxdayu
    ...
    dataview_folder = r'D:\Anaconda3\jupyter notebook files\因子复现\data'
...
from Template import alpha52,alpha55,alpha100,alpha184,alpha189,minusDI_u,InformationRatio120,NetProfitRatio_u

for f in ['alpha52','alpha55','alpha100','alpha184','alpha189','minusDI_u','InformationRatio120','NetProfitRatio_u']:
